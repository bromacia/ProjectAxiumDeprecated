...
class prof_npc : public CreatureScript

    {
public:

prof_npc() : CreatureScript("prof_npc") {}

struct prof_npcAI : public ScriptedAI
    {
        prof_npcAI(Creature *c) : ScriptedAI(c)
        {
        }
    ...
    {
        return new prof_npcAI(_creature);
    }
