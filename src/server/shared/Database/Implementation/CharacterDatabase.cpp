...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    "item, itemEntry, TransmogEntry, TransmogOwner FROM character_inventory ci JOIN item_instance ii ON ci.item = ii.guid WHERE ci.guid = ? ORDER BY bag, slot", CONNECTION_ASYNC)
