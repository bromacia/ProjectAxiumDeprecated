...
enum WorldFloatConfigs
{
    ...
    CONFIG_DMG_ADJ_WARRIOR,
    CONFIG_DMG_ADJ_PALADIN,
    CONFIG_DMG_ADJ_DEATHKNIGHT,
    CONFIG_DMG_ADJ_HUNTER,
    CONFIG_DMG_ADJ_SHAMAN,
    CONFIG_DMG_ADJ_ROGUE,
    CONFIG_DMG_ADJ_DRUID,
    CONFIG_DMG_ADJ_PRIEST,
    CONFIG_DMG_ADJ_MAGE,
    CONFIG_DMG_ADJ_WARLOCK,
